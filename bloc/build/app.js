...
exports.MyCounterBloc = void 0;
var bloc_1 = require("./lib/bloc");
;
var CarEvents;
(function (CarEvents) {
    CarEvents["add"] = "add";
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = event;
                        switch (_a) {
                            case "INCREAMENT" /* CounterEvent.increament */: return [3 /*break*/, 1];
                            case "DECREAMENT" /* CounterEvent.decreament */: return [3 /*break*/, 4];
                        }
                        return [3 /*break*/, 7];
                    case 1:
                        console.log("inc");
...
(function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            counterBloc = new MyCounterBloc();
            counterBloc.on("INCREAMENT" /* CounterEvent.increament */, function (state) { return state + 100; });
            counterBloc.execute("INCREAMENT" /* CounterEvent.increament */);
            // counterBloc.execute(CounterEvent);
